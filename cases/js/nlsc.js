...
const NlscMethods = {
  ...
  //  國土功能分區圖 查詢連結
  // ══════════════════════════════════════════════════════════════════════
  //  注意：國土功能分區圖是由各直轄市、縣（市）政府各自劃設、各自公告，
  //  進度不一（草案公展 / 報部審議 / 已核定），內政部國土管理署並未提供
  //  單一、全國統一、可直接嵌入地圖套疊的 WMS/WMTS 服務。
  //  這裡改為連到官方的「直轄市、縣（市）國土功能分區圖展示資訊查詢系統」，
  //  使用者可在該系統依縣市/地號查詢公告內容（僅供參考，仍以縣市政府公告為準）。
  zoningQueryUrl() {
    return 'https://nluz.nlma.gov.tw/ex3s/ExWeb.aspx';
  },
};
